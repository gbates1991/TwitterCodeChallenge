...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.dateFormatterUser = [[NSDateFormatter alloc] init];
    [self.dateFormatterUser setDateFormat:@"HH:mm, dd/MM/yyyy"];
    [self.dateFormatterUser setLocale:usLocale];
    [self.dateFormatterUser setTimeZone:[NSTimeZone systemTimeZone]];
